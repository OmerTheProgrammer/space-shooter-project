...
namespace Test
{
    public class Program
    {
        ...
        public static async Task ServerFullMain()
        {
            ...
            // 5. Insert new Admin
            (linesChanged, error) = await api.InsertAdmin(new Admin { Birthday = new DateTime(2022, 3, 2) });
            if(error != null) {  Console.WriteLine(error); }
            else { Console.WriteLine($"InsertAdmins Result (Rows Affected): {linesChanged}\n"); }
            ...
            (linesChanged, error) = await api.UpdateAdmin(
            ...
            if (error != null) { Console.WriteLine(error); }
            else { Console.WriteLine($"UpdateAdmins Result (Rows Affected): {linesChanged}\n"); }
            ...
            (linesChanged, error) = await api.DeleteAdmin(admins.Last().Idx);
            if (error != null) { Console.WriteLine(error); }
            else { Console.WriteLine($"DeleteAdmin Result (Rows Affected): {linesChanged}\n"); }
                // 9. Get All (Updated list)
                admins = await api.GetAllAdmins();
            ...
            // 3. Insert new Group
            (linesChanged, error) = await api.InsertGroup(new Group { Name = "Alpha Team", Score = 100 });
            if (error != null) { Console.WriteLine(error); }
            else { Console.WriteLine($"InsertGroup Result (Rows Affected): {linesChanged}\n"); }
            ...
            (linesChanged, error) = await api.UpdateGroup(
            ...
            if (error != null) { Console.WriteLine(error); }
            else{ Console.WriteLine($"UpdateGroup Result (Rows Affected): {linesChanged}\n"); }
            ...
            // 6. Delete the Group
            (linesChanged, error) = await api.DeleteGroup(groups.Last().Idx);
            if (error != null) { Console.WriteLine(error); }
            else { Console.WriteLine($"DeleteGroup Result (Rows Affected): {linesChanged}\n");}
            #endregion
            ...
            (linesChanged, error) = await api.InsertPlayer(new Player
            {
            ...
            (linesChanged, error) = await api.UpdatePlayer(
            ...
            // 6. Delete the Player
            (linesChanged, error) = await api.DeletePlayer(players.Last().Idx);
            if (error != null) { Console.WriteLine(error); }
            else
            {
            ...
            // 7. Verify the delete
            players = await api.GetAllPlayers();
            Console.WriteLine($"after Deleted Player: {players.Last()}\n");
            #endregion
            ...
            (linesChanged, error) = await api.InsertPlayerAndGroup(
                    new PlayerAndGroup
                    {
            ...
            // 3. Perform a Update
            (linesChanged, error) = await api.UpdatePlayerAndGroup(
            ...
            // 6. Delete the Group
            (linesChanged,error) = await api.DeletePlayerAndGroup(playersAndGroups.Last().Idx);
            if (error != null) { Console.WriteLine(error); }
            else
            {
            ...
            // 3. Insert new Group
            (linesChanged, error) = await api.InsertProfileEditRequest(
            ...
            // 3. Perform a Update
            (linesChanged, error) = await api.UpdateProfileEditRequest(
            ...
            (linesChanged, error) = await api.DeleteProfileEditRequest(
            ...
            (linesChanged, error) = await api.InsertRequestData(new RequestData
            {
            ...
            (linesChanged, error) = await api.UpdateRequestData(
            ...
            (linesChanged, error) = await api.DeleteRequestData(requestDataItems.Last().Idx);
            if (error != null) { Console.WriteLine(error); }
            else
            {
            ...
            (linesChanged, error) = await api.InsertRunInfo(new RunInfo
            {
            ...
            (linesChanged, error) = await api.UpdateRunInfo(
            ...
            (linesChanged, error) = await api.DeleteRunInfo(runs.Last().Idx);
            if (error != null) { Console.WriteLine(error); }
            else
            {
            ...
            // 3. Insert new User
            (linesChanged, error) = await api.InsertUser(new User
            {
            ...
            (linesChanged, error) = await api.UpdateUser(
            ...
            // 6. Delete the User
            (linesChanged, error) = await api.DeleteUser(users.Last().Idx);
            if (error != null) { Console.WriteLine(error); }
            else
            {
